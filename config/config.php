 ...
 */
$GLOBALS['FE_MOD']['application']['pc_skype'] = 'ModulePcSkype';
 ...
 */
$GLOBALS['TL_CTE']['applications']['pc_skype'] = 'ContentPcSkype';
 ...
 */
$GLOBALS['TL_HOOKS']['replaceInsertTags'][] = array('PcSkype', 'generateInserttag');
